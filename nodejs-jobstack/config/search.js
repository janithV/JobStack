...
!function(a) {
  var b = "0.9.3"
      ...
      return c.mixin(b.prototype, {
          ...
          _sendRequest: function(b) {
              function c() {
                  e(),
                  k[b] = null,
                  f.onDeckRequestArgs && (f._get.apply(f, f.onDeckRequestArgs),
                  f.onDeckRequestArgs = null)
              }
              var f = this
                , g = k[b];
              return g || (d(),
              g = k[b] = a.ajax(b, this.ajaxSettings).always(c)),
              g
          },
          get: function(a, b) {
    ...
    , i = function() {
      ...
      function e(a, b, d) {
          var e, f;
          return c.isFunction(a) ? e = a : c.isString(a) ? (f = b.compile(a),
          e = c.bind(f.render, f)) : e = function(a) {
              return "<p>" + a[d] + "</p>"
          }
          ,
          e
      ...
      return c.mixin(d.prototype, {
          ...
          _loadPrefetchData: function(d) {
              ...
              i && j && !k ? (this._mergeProcessedData({
                  itemHash: i,
                  adjacencyList: j
              }),
          ...
          getSuggestions: function(a, b) {
              ...
              var e, f, g = this, h = !1;
              a.length < this.minLength || (e = c.tokenizeQuery(a),
              f = this._getLocalSuggestions(e).slice(0, this.limit),
              f.length < this.limit && this.transport && (h = this.transport.get(a, d)),
              !h && b && b(f))
          }
      }),
      d
    ...
    , k = function() {
      ...
      return c.mixin(b.prototype, d, {
          ...
          clearSuggestions: function(a) {
              ...
              b.hide(),
              c.empty(),
              0 === this._getSuggestions().length && (this.isEmpty = !0,
              this._hide())
          }
      }),
      b
